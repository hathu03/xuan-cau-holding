<div class="typography h-section-2" id="gioi-thieu">
    <img width="1440px" height="676px" class="s2-bg" src="<?php echo THEME_ASSETS . '/images/homes/s2-image.jpg' ?>"
        alt="">
        ...
        <div class="tw-wrapper">
            <div class="context">
                ...
                <div class="right animate__animated animate__fadeInDown animate__delay-2s wow slideInRight"
                    ...
                    <p>Với sứ mệnh “Cống hiến giá trị đích thực” và tôn chỉ “Kiến tạo cuộc sống xanh”, Xuân Cầu Holdings
                        tập trung nguồn lực, ý chí và định hướng trở thành một Tổ chức kinh doanh uy tín, hoạt động hiệu
                        quả thông qua việc cung cấp các sản phẩm chất lượng và bền vững.</p>
                    <br>
